...
class BlinkFeaturize(object):
    ...
    def CreateFeatureSet(self, xRaw, yRaw, includeEdgeFeatures=True, includeEdgeFeaturesMax=True, includeRawPixels=False, includeIntensities=False, intensitiesSampleStride = 2):
        ...
        self.includeEdgeFeaturesMax = includeEdgeFeaturesMax
    ...
    def _FeaturizeX(self, xRaw):
        ...
        if self.includeEdgeFeatures:
            ...
            if self.includeEdgeFeaturesMax: 
